...
import com.ufoStyle.salesystem.domain.events.CustomerErrorMessage;
import com.ufoStyle.salesystem.domain.services.CustomerService;
...
public class CustomerController {
    ...
    private String formatMessage( BindingResult result){
        ...
        CustomerErrorMessage customerErrorMessage = CustomerErrorMessage.builder()
                .code("01")
                .messages(errors).build();
        ObjectMapper mapper = new ObjectMapper();
        String jsonString="";
        try {
            jsonString = mapper.writeValueAsString(customerErrorMessage);
